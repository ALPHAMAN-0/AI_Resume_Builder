    ...
    <div className="step-card">
      <div className="flex items-center gap-3 p-4">
        <div className="flex-1 min-w-0">
          <p className="font-medium text-slate-800 dark:text-slate-100 truncate">{edu.institution || 'University Name'}</p>
          <p className="text-sm text-slate-500 dark:text-slate-400 truncate">{[edu.degree, edu.field].filter(Boolean).join(' in ') || 'Degree & Field'}</p>
        </div>
      ...
      {expanded && (
        <div className="space-y-4 border-t step-card-divider p-4">
          <div>
            <label className="mb-1 block field-label-sm">Institution</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="mb-1 block field-label-sm">Degree</label>
            ...
            <div>
              <label className="mb-1 block field-label-sm">Field of Study</label>
          ...
          <div>
            <label className="mb-1 block field-label-sm">Relevant Coursework (optional)</label>
